document.addEventListener('DOMContentLoaded', function(){
    ...
    const modal = document.querySelector('#js-personal-modal'),
        open = document.querySelector('#js-personal-modal-open'),
        close = document.querySelector('#js-personal-modal-close');
